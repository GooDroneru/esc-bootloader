...
#include "main.h"
#include "esc/memorymap.h"

/* BOOTLOADER_VERSION is the flash address from memorymap.h (0x0000F810) */
...
#define CH32_FLASH_START 0x08000000

/* Addresses come from the linker script (esc_ch32v20x_D6.ld):
 * _firmware_start_addr = ADDR(.firmware_start)  (e.g. 0x1000)
 * _eeprom_start_addr   = ADDR(.eeprom)           (e.g. 0xF000)
 * FLASH ORIGIN = 0x00000000, so these values are the offsets from CH32_FLASH_START. */
...
//#define EEPROM_RELATIVE_START 0xFF00
...
static void MX_TIM4_Init(void)  //��Ƶ8M,ʱ��1M
{
    SysTick->CTLR=0;
    SysTick->SR = 0;
    SysTick->CNT=0;
